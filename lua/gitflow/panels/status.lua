...
---@field on_open_diff fun(path: string)|nil

---@class GitflowStatusPanelState
---@field bufnr integer|nil
---@field winid integer|nil
---@field opts GitflowStatusPanelOpts
---@field line_entries table<integer, GitflowStatusEntry>
...
---@param lines string[]
---@param line_entries table<integer, GitflowStatusEntry>
...
local function render(grouped)
	...
	append_section("Staged", grouped.staged, lines, line_entries)
	append_section("Unstaged", grouped.unstaged, lines, line_entries)
	append_section("Untracked", grouped.untracked, lines, line_entries)
...
function M.open_diff_under_cursor()
	...
	if M.state.opts.on_open_diff then
		M.state.opts.on_open_diff(entry.path)
		return
	end
